...
In order to use the NLR HPC systems, you will need to [request a user account](https://www.nrel.gov/hpc/user-accounts.html). For a guide to accessing our systems, please see our [User Basics guide](https://www.nrel.gov/hpc/user-basics.html)
...
??? note "How can I access NLR HPC systems?"
    ...
    Begin by [requesting an NLR HPC account](https://www.nrel.gov/hpc/user-accounts.html). 
    Then, consult our guide on [how to connect to  NLR HPC systems](https://www.nrel.gov/hpc/system-connection.html).
