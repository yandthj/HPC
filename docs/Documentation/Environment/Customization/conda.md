...
## Conda Module
To use Conda on an NLR HPC cluster, you will need to load the appropriate module. To find the Conda module name on the system you are using, run `module spider conda`. Then, `module load <module name>`. 
