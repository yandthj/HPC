...
A 80-user license of GAMS is made available to NLR users. This GAMS license requires users to be a member of the "gams workgroup." If you need the GAMS software package or a specific solver from GAMS, or if you have trouble running GAMS, please [contact us](https://www.nlr.gov/hpc/contact-us.html).
